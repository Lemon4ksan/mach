...
func (c *Cookie) AppendBytes(dst []byte) []byte {
	...
	if c.maxAge != 0 {
		...
		if c.maxAge < 0 {
			...
			dst = bytesutil.AppendUint(dst, 0)
		} else {
			dst = bytesutil.AppendUint(dst, c.maxAge)
		}
	...
	case CookieSameSiteDefaultMode:
		dst = append(dst, ';', ' ')
		dst = append(dst, bytesutil.StrCookieSameSite...)
	case CookieSameSiteLaxMode:
		dst = append(dst, ';', ' ')
		dst = append(dst, bytesutil.StrCookieSameSite...)
		dst = append(dst, '=')
		dst = append(dst, bytesutil.StrCookieSameSiteLax...)
	case CookieSameSiteStrictMode:
		dst = append(dst, ';', ' ')
		dst = append(dst, bytesutil.StrCookieSameSite...)
		dst = append(dst, '=')
		dst = append(dst, bytesutil.StrCookieSameSiteStrict...)
...
func parseCookieExpires(src []byte) (time.Time, error) {
	if t, ok := bytesutil.ParseRFC1123DateGMT(src); ok {
		return t, nil
	}
