...
func (a *Args) DelBytes(key []byte) {
	a.args = delAllArgsStable(a.args, bytesutil.B2S(key))
}
...
func (a *Args) AddBytesK(key []byte, value string) {
	a.args = appendArg(a.args, bytesutil.B2S(key), value, argsHasValue)
}
...
func (a *Args) AddBytesV(key string, value []byte) {
	a.args = appendArg(a.args, key, bytesutil.B2S(value), argsHasValue)
}
...
func (a *Args) AddBytesKV(key, value []byte) {
	a.args = appendArg(a.args, bytesutil.B2S(key), bytesutil.B2S(value), argsHasValue)
}
...
func (a *Args) AddBytesKNoValue(key []byte) {
	a.args = appendArg(a.args, bytesutil.B2S(key), "", argsNoValue)
}
...
func (a *Args) SetBytesK(key []byte, value string) {
	a.args = setArg(a.args, bytesutil.B2S(key), value, argsHasValue)
}

// SetBytesV sets 'key=value' argument.
func (a *Args) SetBytesV(key string, value []byte) {
	a.args = setArg(a.args, key, bytesutil.B2S(value), argsHasValue)
}
...
func (a *Args) SetBytesKNoValue(key []byte) {
	a.args = setArg(a.args, bytesutil.B2S(key), "", argsNoValue)
}
...
func (a *Args) PeekMultiBytes(key []byte) [][]byte {
	return a.PeekMulti(bytesutil.B2S(key))
}
...
func (a *Args) HasBytes(key []byte) bool {
	return hasArg(a.args, bytesutil.B2S(key))
}
...
func (a *Args) SetUint(key string, value int) {
	a.buf = bytesutil.AppendUint(a.buf[:0], value)
	a.SetBytesV(key, a.buf)
}

// SetUintBytes sets uint value for the given key.
func (a *Args) SetUintBytes(key []byte, value int) {
	a.SetUint(bytesutil.B2S(key), value)
}
...
func setArgBytes(h []argsKV, key, value []byte, noValue bool) []argsKV {
	return setArg(h, bytesutil.B2S(key), bytesutil.B2S(value), noValue)
}
...
func (s *argsScanner) next(kv *argsKV) bool {
	...
	if isKey {
		kv.key = bytesutil.DecodeArgAppend(kv.key[:0], s.b)
		kv.value = kv.value[:0]
		kv.noValue = argsNoValue
	} else {
