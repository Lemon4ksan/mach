...
var targets = []fuzzTarget{
	{"./client/h1", "FuzzH1Request"},
	{"./client/h1", "FuzzH1Response"},
	{"./client/h1", "FuzzH1URI"},
	{"./core/h2", "FuzzHPACKDecode"},
	{"./core/h2", "FuzzFrameRead"},
	{"./core/h3", "FuzzQPACKDecode"},
	{"./core/h3", "FuzzH3FrameHeaderRead"},
	{"./qpack", "FuzzQPACKDecoder"},
	{"./qpack", "FuzzVarint"},
	{"./quic", "FuzzFrameSorter"},
	{"./quic", "FuzzFindSNI"},
	{"./quic/internal/handshake", "FuzzHandshake"},
	{"./quic/internal/wire", "FuzzFrames"},
	{"./quic/internal/wire", "FuzzHeaderParser"},
	{"./quic/internal/wire", "FuzzTransportParameters"},
