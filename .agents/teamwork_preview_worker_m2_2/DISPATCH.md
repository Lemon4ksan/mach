# Dispatch Assignment — Milestone M2 Worker
...
## Output:
- Write detailed progress to `.agents/teamwork_preview_worker_m2_2/progress.md`.
- Upon completion, write self-contained `handoff.md` in `.agents/teamwork_preview_worker_m2_2/` with test/benchmark results and notify parent via `send_message`.
